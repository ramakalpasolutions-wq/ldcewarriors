  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ fontSize: '12px', fontWeight: 600, color: tk.text }}>
          {current.label}
        </span>
        <span style={{
      ...
      <div style={{
        ...
        background: 'rgba(27,42,74,0.08)', overflow: 'hidden',
      }}>
        <div style={{
        ...
        {stages.map((s, i) => (
          <div key={s.key} style={{
            ...
            background: stages.indexOf(current) >= i
              ? `linear-gradient(90deg,${tk.navy},${tk.gold})`
              : 'rgba(27,42,74,0.1)',
...
function FileDropZone({
  label, accept, hint, file, preview,
  ...
  return (
    <div>
      <label style={{
        ...
        {hint && (
          <span style={{
            color: tk.faint, fontWeight: 400, marginLeft: '4px',
          }}>({hint})</span>
        )}
      </label>
      ...
      <div
        ...
        style={{
          ...
          background: drag
            ...
            : file ? 'rgba(42,157,143,0.04)' : 'rgba(27,42,74,0.02)',
      ...
      >
        ...
        {preview ? (
          ...
          <div style={{
            ...
            <span style={{
              fontSize: '11px', fontWeight: 600, color: tk.text,
              wordBreak: 'break-all', maxWidth: '140px',
            }}>{file.name}</span>
            <span style={{ fontSize: '10px', color: tk.faint }}>
              {fmtSize(file.size)}
            </span>
          </div>
        ) : (
          <div style={{
            ...
            <p style={{ fontSize: '10px', color: tk.faint, margin: 0 }}>
              {accept}
            </p>
          </div>
        )}
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', gap: '10px', marginBottom: '10px' }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <p style={{
            ...
            whiteSpace: 'nowrap', marginBottom: '5px',
          }}>{video.title}</p>
          <div style={{
            ...
            <span style={{
              ...
              background: video.type === 'premium'
                ? 'rgba(232,168,56,0.12)' : 'rgba(42,157,143,0.1)',
              color: video.type === 'premium' ? tk.goldDark : tk.teal,
              border: `1px solid ${video.type === 'premium'
                ? 'rgba(232,168,56,0.25)' : 'rgba(42,157,143,0.2)'}`,
            }}>
      ...
      <div style={{
        ...
        {[
          ...
          {
            lbl: 'PLAYS',
            val: video.type === 'premium'
              ? `🔒 ${video.playLimit || 3} max` : 'Unlimited',
          },
          ...
          <div key={item.lbl}>
            <p style={{
              fontSize: '9px', color: tk.faint,
              fontWeight: 700, marginBottom: '2px',
            }}>{item.lbl}</p>
            <p style={{
              fontSize: '12px', color: tk.text, fontWeight: 600,
            }}>{item.val}</p>
          </div>
        ))}
      </div>
      ...
      <div style={{
        ...
        <label style={{
          ...
          <div style={{ position: 'relative', width: '34px', height: '19px' }}>
            <input type="checkbox" checked={video.isActive}
            ...
            <div style={{
              ...
              background: video.isActive ? tk.teal : '#E5E7EB',
              transition: '0.3s',
            }}>
              <div style={{
          ...
          <span style={{
            fontSize: '11px', color: tk.muted, fontWeight: 500,
          }}>
        ...
        <div style={{ display: 'flex', gap: '7px' }}>
          ...
          <button
            ...
            style={{
              ...
              opacity: deleting === video._id ? 0.5 : 1,
              fontFamily: 'inherit',
            }}>
    ...
    <div style={{
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{
          ...
          <span style={{ fontSize: '11px', color: tk.faint }}>
            👁 {video.views || 0}
          </span>
          <span style={{ fontSize: '11px', color: tk.faint }}>
            {fmtDateShort(video.createdAt)}
          </span>
          {video.showOnHomepage && (
            <span style={{
              fontSize: '10px', fontWeight: 700, color: tk.teal,
...
export default function AdminVideosPage() {
  ...
  // ✅ KEY CHANGE: Upload files directly from browser, send only URLs to API
  async function handleUpload(e) {
    ...
    try {
      ...
      const videoResult = await uploadVideoToR2Direct(
        ...
        'videos',
        (percent) => {
          // Map 0-100% video progress to 20-85% overall
          setUploadProgress(20 + Math.round(percent * 0.65))
        }
      )
      console.log('✅ Video uploaded to R2:', videoResult.publicUrl)
      setUploadProgress(88)

      // Step 3: Save metadata to database via API (tiny JSON, no files)
  ...
  async function handleEdit(video) {
    ...
    setTimeout(() => {
      document.querySelector('.vp-form')?.scrollIntoView({
    ...
    try {
      ...
      if (data.success) {
        setVideos(prev => prev.map(v =>
          v._id === video._id ? { ...v, isActive: !v.isActive } : v
        ))
  ...
  const FILTER_TABS = [
    { id: 'all', label: 'All', count: videos.length },
    {
      id: 'free',
      label: isMobile ? '🎬' : '🎬 Free',
      count: videos.filter(v => v.type === 'free').length,
    },
    {
      id: 'premium',
      label: isMobile ? '⭐' : '⭐ Premium',
      count: videos.filter(v => v.type === 'premium').length,
    },
  ]
  ...
  const EmptyState = () => (
    <div style={{
      ...
      <p style={{
        color: tk.muted, fontWeight: 600,
        marginBottom: '4px',
        fontSize: isMobile ? '13px' : '14px',
      }}>No videos found</p>
      <p style={{ color: tk.faint, fontSize: '12px' }}>
        {filter !== 'all' || topicFilt !== 'all'
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .vp-stat-lbl {
          font-size: 11px; color: ${tk.faint}; font-weight: 500;
        }
        .vp-tab {
        ...
        .vp-tab-count {
          margin-left: 4px; background: rgba(255,255,255,.2);
          border-radius: 5px; padding: 1px 5px; font-size: 10px;
        }
        .vp-tab-off .vp-tab-count {
          background: rgba(27,42,74,.08); color: ${tk.muted};
        }
        .vp-form {
        ...
        .vp-table th {
          ...
          color: ${tk.faint}; text-transform: uppercase;
          letter-spacing: .7px; text-align: left;
          border-bottom: 1.5px solid ${tk.border}; white-space: nowrap;
        }
        .vp-table td {
      ...
      <div className="vp">
        ...
        <div style={{
          ...
          <div>
            <h1 style={{
              ...
              fontSize: 'clamp(17px,3vw,23px)', color: tk.text,
              marginBottom: '3px',
            }}>🎬 Video Manager</h1>
          ...
          <div style={{
            ...
            <button
              onClick={fetchVideos} disabled={loading}
              className="adm-btn-secondary" title="Refresh"
            >
              <span style={{
        ...
        <div className="vp-stats">
          {[
            ...
            {
              val: videos.filter(v => v.type === 'premium').length,
              lbl: 'Premium',
            },
            { val: topics.length, lbl: 'Topics' },
            {
              val: videos.reduce((s, v) => s + (v.views || 0), 0),
              lbl: 'Views',
            },
          ].map(s => (
            <div key={s.lbl} className="vp-stat">
              <div className="vp-stat-val">
                {loading
                  ? <div style={{
                    height: '16px', width: '32px', borderRadius: '5px',
                    background: '#F0F1F3',
                  }} />
                  : s.val}
              </div>
        ...
        {showForm && (
          <div className="adm-card vp-form" style={{ paddingTop: '24px' }}>
            ...
            <h3 style={{
              fontWeight: 700, color: tk.text, fontSize: '14px',
              marginBottom: '18px',
            ...
            <form
              onSubmit={editVideo ? handleUpdate : handleUpload}
            ...
            >
              ...
              <div className="vp-fg2">
                <div>
                  <label className="vp-lbl">
                    Title <span style={{ color: tk.gold }}>*</span>
                  </label>
                  <input
                ...
                <div>
                  <label className="vp-lbl">
                    Type <span style={{ color: tk.gold }}>*</span>
                  </label>
                  <select
                    className="adm-input" value={form.type}
              ...
              {/* Row 2: Topic + Order + Play Limit */}
              <div className="vp-fg3">
                <div>
                  <label className="vp-lbl">Topic</label>
                  <select
                    className="adm-input" value={form.topicId}
                ...
                <div>
                  ...
                  <input
                    ...
                    value={form.order} min={0}
                    onChange={e => setForm({
                      ...form, order: parseInt(e.target.value) || 0,
                    })}
                    disabled={uploading}
                  />
                </div>
                <div>
                  <label className="vp-lbl">
                    Play Limit
                    <span style={{
                      color: tk.faint, fontWeight: 400, marginLeft: '3px',
                    }}>(per user)</span>
                  </label>
                  <input
                    type="number" className="adm-input"
                    value={form.playLimit} min={1} max={10}
                    onChange={e => setForm({
                      ...form, playLimit: parseInt(e.target.value) || 3,
                    })}
                    disabled={uploading}
                  />
                </div>
              ...
              <div className="vp-opts">
                <label className="vp-chk">
                  <input
                    type="checkbox" checked={form.showOnHomepage}
                    onChange={e => setForm({
                      ...form, showOnHomepage: e.target.checked,
                    })}
                    disabled={uploading}
                  />
                ...
                {form.type === 'premium' && (
                  <div style={{
                    ...
                    <span>🔒</span>
                    <span style={{
                      fontSize: '12px', color: tk.muted, fontWeight: 500,
                    }}>
                      <strong style={{ color: tk.gold }}>
                        {form.playLimit}
                      </strong> plays max
                    </span>
                  </div>
                  ...
                  {uploading ? (
                    <>
                      <svg style={{
                        ...
                        <circle
                          style={{ opacity: .25 }} cx="12" cy="12" r="10"
                          stroke="currentColor" strokeWidth="4"
                        />
                        <path
                          style={{ opacity: .75 }} fill="currentColor"
        ...
        <div style={{
          ...
          <div style={{
            ...
            <select
              ...
              style={{
                ...
                fontSize: '12px', padding: '6px 9px',
              }}
              value={topicFilt}
              onChange={e => setTopicFilt(e.target.value)}
            >
          ...
          <span style={{
            fontSize: '11px', color: tk.faint, whiteSpace: 'nowrap',
          }}>
        ...
        {isMobile ? (
          ...
          <div style={{
            background: tk.card, border: `1.5px solid ${tk.border}`,
            borderRadius: '14px', overflow: 'hidden', padding: '12px',
          }}>
            {loading
              ? [1, 2, 3, 4].map(i => (
                <div key={i} style={{
                        ...
                        <tr key={video._id}>
                          ...
                          <td>
                            <label className="vp-toggle">
                              <input
                                type="checkbox" checked={video.isActive}
                                onChange={() => toggleActive(video)}
                              />
                          ...
                          <td style={{ textAlign: 'right' }}>
                            <div style={{
                              ...
                              <button
                                ...
                                className="vp-act-edit"
                              >✏️</button>
                              <button
                                onClick={() => handleDelete(video._id)}
                                disabled={deleting === video._id}
                                className="vp-act-del"
                              >
                                {deleting === video._id ? '…' : '🗑️'}
                              </button>
                            </div>
